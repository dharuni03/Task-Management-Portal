        ...
        <div className="xtasks-wrapper">
          <div className="xtask">
            ...
            <label htmlFor="xitem-1">
              <span className="xlabel-text">Dashboard Design Implementation</span>
            </label>
          ...
          <div className="xtask">
            ...
            <label htmlFor="xitem-2">
              <span className="xlabel-text">Create a userflow</span>
            </label>
          ...
          <div className="xtask">
            ...
            <label htmlFor="xitem-3">
              <span className="xlabel-text">Application Implementation</span>
            </label>
          ...
          <div className="xtask">
            ...
            <label htmlFor="xitem-4">
              <span className="xlabel-text">Create a Dashboard Design</span>
            </label>
            <span className="xtag progress">In Progress</span>
          </div>
          <div className="xtask">
            ...
            <label htmlFor="xitem-5">
              <span className="xlabel-text">Create a Web Application Design</span>
            </label>
            <span className="xtag approved">Approved</span>
          </div>
          <div className="xtask">
            ...
            <label htmlFor="xitem-6">
              <span className="xlabel-text">Interactive Design</span>
            </label>
            <span className="xtag review">In Review</span>
          </div>
